...
** Main System
#+begin_src lisp :tangle (expand-file-name "../opencortex.asd" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/harness"))
...
** Test Orchestrator
#+begin_src lisp :tangle (expand-file-name "run-all-tests.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/harness"))
