#+PROPERTY: header-args:lisp :tangle (expand-file-name "context.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
...
** Test Suite Context
#+begin_src lisp :tangle (expand-file-name "peripheral-vision-tests.lisp" (concat (or (identity (getenv "INSTALL_DIR")) ".") "/tests"))
