...
** Package Context
#+begin_src lisp :tangle (expand-file-name "memory.lisp" (expand-file-name "harness/" (or (identity (getenv "INSTALL_DIR")) ".")))
...
#+begin_src lisp :tangle (expand-file-name "memory-tests.lisp" (concat (or (identity (getenv "INSTALL_DIR")) ".") "/tests"))
