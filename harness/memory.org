...
** Package Context
#+begin_src lisp :tangle (expand-file-name "memory.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/harness"))
...
#+begin_src lisp :tangle (expand-file-name "memory-tests.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/tests"))
