#+PROPERTY: header-args:lisp :tangle (expand-file-name "skills.lisp" (concat (or (identity (getenv "INSTALL_DIR")) ".") "/harness"))
...
#+begin_src lisp :tangle (expand-file-name "skills.lisp" (concat (or (identity (getenv "INSTALL_DIR")) ".") "/harness"))
