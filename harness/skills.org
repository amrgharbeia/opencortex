#+PROPERTY: header-args:lisp :tangle (expand-file-name "skills.lisp" (expand-file-name "harness/" (or (identity (getenv "INSTALL_DIR")) ".")))
...
#+begin_src lisp :tangle (expand-file-name "skills.lisp" (expand-file-name "harness/" (or (identity (getenv "INSTALL_DIR")) ".")))
