#+PROPERTY: header-args:lisp :tangle (expand-file-name "skills.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/harness"))
...
#+begin_src lisp :tangle (expand-file-name "skills.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/harness"))
...
#+begin_src lisp :tangle (expand-file-name "boot-sequence-tests.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/tests"))
