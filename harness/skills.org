#+PROPERTY: header-args:lisp :tangle (expand-file-name "skills.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
...
#+begin_src lisp :tangle (expand-file-name "skills.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
...
#+begin_src lisp :tangle (expand-file-name "boot-sequence-tests.lisp" (concat (or (identity (getenv "INSTALL_DIR")) ".") "/tests"))
