...
** Package Context
#+begin_src lisp :tangle (expand-file-name "doctor-tests.lisp" (concat (or (identity (getenv "INSTALL_DIR")) ".") "/tests"))
...
** Package Context
#+begin_src lisp :tangle (expand-file-name "doctor.lisp" (concat (or (identity (getenv "INSTALL_DIR")) ".") "/harness"))
