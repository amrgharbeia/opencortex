#+PROPERTY: header-args:lisp :tangle (expand-file-name "harness/communication.lisp" (expand-file-name "harness/"))
...
#+begin_src lisp :tangle (expand-file-name "harness/communication-validator.lisp" (expand-file-name "harness/"))
(in-package :opencortex)
...
#+begin_src lisp :tangle (expand-file-name "harness/communication-tests.lisp" (concat (concat (or (getenv "INSTALL_DIR") ".") "/harness") "/tests"))
