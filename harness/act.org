#+PROPERTY: header-args:lisp :tangle (expand-file-name "act.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/harness"))
...
#+begin_src lisp :tangle (expand-file-name "pipeline-act-tests.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/tests"))
