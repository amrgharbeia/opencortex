#+PROPERTY: header-args:lisp :tangle (expand-file-name "perceive.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/harness"))
...
#+begin_src lisp :tangle (expand-file-name "pipeline-perceive-tests.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/tests"))
