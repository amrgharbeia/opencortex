#+PROPERTY: header-args:lisp :tangle (expand-file-name "loop.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/harness"))
...
#+begin_src lisp :tangle (expand-file-name "immune-system-tests.lisp" (concat (or (uiop:getenv "INSTALL_DIR") ".") "/tests"))
