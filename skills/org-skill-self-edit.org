#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-self-edit.lisp" (expand-file-name "skills/" (or (identity (getenv "INSTALL_DIR")) ".")))
:PROPERTIES:
:ID:       self-edit-001
:END:
...
#+begin_src lisp :tangle (expand-file-name "self-edit-tests.lisp" (expand-file-name "skills/" (or (identity (getenv "INSTALL_DIR")) ".")))
