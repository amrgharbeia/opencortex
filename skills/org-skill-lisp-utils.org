#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-lisp-utils.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
:PROPERTIES:
:ID:       lisp-utils-skill
...
#+begin_src lisp :tangle (expand-file-name "lisp-utils-tests.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
