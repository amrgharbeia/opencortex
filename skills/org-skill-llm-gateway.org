#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-llm-gateway.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
:PROPERTIES:
:ID:       llm-gateway-spec
...
* Test Suite
#+begin_src lisp :tangle (expand-file-name "llm-gateway-tests.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
...
** Package Context
#+begin_src lisp :tangle (expand-file-name "org-skill-llm-gateway.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
