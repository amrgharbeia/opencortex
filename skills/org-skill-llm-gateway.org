#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-llm-gateway.lisp" (expand-file-name "skills/" (or (identity (getenv "INSTALL_DIR")) ".")))
:PROPERTIES:
:ID:       llm-gateway-spec
...
* Test Suite
#+begin_src lisp :tangle (expand-file-name "llm-gateway-tests.lisp" (expand-file-name "skills/" (or (identity (getenv "INSTALL_DIR")) ".")))
...
** Package Context
#+begin_src lisp :tangle (expand-file-name "org-skill-llm-gateway.lisp" (expand-file-name "skills/" (or (identity (getenv "INSTALL_DIR")) ".")))
