#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-protocol-validator.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
:PROPERTIES:
