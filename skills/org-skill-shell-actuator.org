#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-shell-actuator.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
:PROPERTIES:
...
#+begin_src lisp :tangle (expand-file-name "org-skill-shell-actuator.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
