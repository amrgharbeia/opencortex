#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-emacs-edit.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
:PROPERTIES:
:ID:       emacs-edit-skill
...
#+begin_src lisp :tangle (expand-file-name "emacs-edit-tests.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
