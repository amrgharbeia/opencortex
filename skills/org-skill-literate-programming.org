#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-literate-programming.lisp" (expand-file-name "skills/" (or (identity (getenv "INSTALL_DIR")) ".")))
:PROPERTIES:
...
#+begin_src lisp :tangle (expand-file-name "literate-programming-tests.lisp" (expand-file-name "skills/" (or (identity (getenv "INSTALL_DIR")) ".")))
