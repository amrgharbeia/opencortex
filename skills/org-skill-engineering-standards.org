#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-engineering-standards.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
:PROPERTIES:
...
** Package Context
#+begin_src lisp :tangle (expand-file-name "org-skill-engineering-standards.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
...
#+begin_src lisp :tangle (expand-file-name "engineering-standards-tests.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
