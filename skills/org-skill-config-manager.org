...
** Test Suite Context
#+begin_src lisp :tangle (expand-file-name "config-manager-tests.lisp" (expand-file-name "skills/" (or (identity (getenv "INSTALL_DIR")) ".")))
...
** Package Context
#+begin_src lisp :tangle (expand-file-name "org-skill-config-manager.lisp" (expand-file-name "skills/" (or (identity (getenv "INSTALL_DIR")) ".")))
