...
** Test Suite Context
#+begin_src lisp :tangle (expand-file-name "config-manager-tests.lisp" (expand-file-name "" (concat (or (identity (getenv "INSTALL_DIR")) ".") "/skills")))
...
** Package Context
#+begin_src lisp :tangle (expand-file-name "org-skill-config-manager.lisp" (expand-file-name "" (concat (or (identity (getenv "INSTALL_DIR")) ".") "/skills")))
