...
** Test Suite Context
#+begin_src lisp :tangle (expand-file-name "config-manager-tests.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
...
** Package Context
#+begin_src lisp :tangle (expand-file-name "org-skill-config-manager.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
