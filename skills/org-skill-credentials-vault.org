#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-credentials-vault.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
:PROPERTIES:
...
** 1. Unit Tests (FiveAM)
#+begin_src lisp :tangle (expand-file-name "org-skill-credentials-vault.lisp" (or (identity (getenv "INSTALL_DIR")) (file-name-directory (buffer-file-name))))
#|
