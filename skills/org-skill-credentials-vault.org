#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-credentials-vault.lisp" (expand-file-name "" (concat (or (identity (getenv "INSTALL_DIR")) ".") "/skills")))
:PROPERTIES:
...
** 1. Unit Tests (FiveAM)
#+begin_src lisp :tangle (expand-file-name "org-skill-credentials-vault.lisp" (expand-file-name "" (concat (or (identity (getenv "INSTALL_DIR")) ".") "/skills")))
#|
