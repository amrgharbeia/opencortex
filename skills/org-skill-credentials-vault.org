#+PROPERTY: header-args:lisp :tangle (expand-file-name "org-skill-credentials-vault.lisp" (expand-file-name "skills/" (or (identity (getenv "INSTALL_DIR")) ".")))
:PROPERTIES:
...
** 1. Unit Tests (FiveAM)
#+begin_src lisp :tangle (expand-file-name "org-skill-credentials-vault.lisp" (expand-file-name "skills/" (or (identity (getenv "INSTALL_DIR")) ".")))
#|
